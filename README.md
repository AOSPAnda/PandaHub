...
`co.aospa.hub.UpdateConfig`, example file is located
...
`/data/user/0/co.aospa.hub/files/configs/`.
...
4. Run tests
   `adb shell am instrument -w co.aospa.hub.tests/android.support.test.runner.AndroidJUnitRunner`
5. Run a test file
   ```
   adb shell am instrument \
     -w -e class co.aospa.hub.UpdateManagerTest#applyUpdate_appliesPayloadToUpdateEngine \
     co.aospa.hub.tests/android.support.test.runner.AndroidJUnitRunner
   ```
